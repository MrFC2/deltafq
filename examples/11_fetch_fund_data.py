...
def fetch_watchlist_funds(output_dir: str = "fund_data") -> None:
    ...
    for code in watchlist_codes:
        try:
            data = fetcher.fetch_data_from_fund(code=code, page=None)
...
def main() -> None:
    ...
    print("=" * 60)
    data_single = fetcher.fetch_data_from_fund(code="018956", page=1)
    ...
    data_all = fetcher.fetch_data_from_fund(code="018956", page=None)
